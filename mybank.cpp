...
void Bank::update()
{
    cout << "Enter id of account whose data you want to update" << endl;
    cin >> id;
    for (int i = 0; i < total; i++)
    {
        if (id == person[i].ID)
...
void Bank::search()
{
    cout << "Enter id of account those data you want to search" << endl;
    cin >> id;
    for (int i = 0; i < total; i++)
    {
        if (id == person[i].ID)
...
void Bank::del()
{
    ...
    {
    case '1':
        cout << "Enter id of account those data you want to remove" << endl;
        cin >> id;
        for (int i = 0; i < total; i++)
        {
            if (id == person[i].ID)
